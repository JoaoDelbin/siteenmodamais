...
export default function Assinatura() {
  // apenas as 5 masterclasses (primeiros 5 itens do array)
  ...
  return (
    <main className="min-h-screen w-full bg-[#0D0A0B] text-white">
      ...
      <DiferenciaisSection />
      <div className="text-center"><CTAButton variant="primary" size="md" className='mb-2 md:mb-0'>
  QUERO COMEÇAR AGORA
</CTAButton></div>
        </section>
      {/* ======= O QUE VOCÊ ACESSA ======= */}
      ...
      {/* ======= CATÁLOGO: SOMENTE MASTER CLASSES ======= */}
      <section className="py-8">
        <div className="max-w-[1200px] mx-auto px-6">
          <h3 className="text-2xl md:text-[26px] font-extrabold">Master classes</h3>
          ...
          <div className="mt-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
            {masterclasses.map((curso) => (
              <div
                key={curso.id}
                className="aspect-[2/4] w-full rounded-[22px] overflow-hidden bg-black/20 border border-white/10"
              >
                <img
